...
| [orchestrator](plugins/orchestrator/README.md) | 0.4.0 | Keeps the main thread in the orchestrator role. Blocks Fable workers, warns when a worker model is missing or unknown, and holds workers to verified reporting. |
